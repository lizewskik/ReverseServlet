...
@WebServlet("/scdver")
public class ScdVer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");
		out.println("<head><title>CGM Exercise v2</title></head>");
		out.println("<body>");
		out.println("<h1>CGM Exercise v2</h1>");
		out.println("<form method=\"post\">");
		out.println("Enter text: <input type\"text\" name=\"word\""
				+ "title=\"Only letters and digits\""
				+ "pattern=\"[A-Za-z0-9]{1,}\">" + "<input type=\"submit\" value=\"Reverse\">");
		out.println("</form>");
		out.println("<a href=\"/CGMExercise/\">Back to first version</a>");
		out.println("</body>");
		out.println("</html>");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<br>");
		out.println("<a href=\"/CGMExercise/scdver\">Try again!</a>");
	}
